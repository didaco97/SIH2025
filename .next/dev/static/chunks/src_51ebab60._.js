...
const firebaseConfig = {
    apiKey: ("TURBOPACK compile-time value", "AIzaSyBMCIcfRVb5kW5yruvXyOi54G26Wz4Hyhk"),
    authDomain: ("TURBOPACK compile-time value", "krishisense-480507.firebaseapp.com"),
    projectId: ("TURBOPACK compile-time value", "krishisense-480507"),
    storageBucket: ("TURBOPACK compile-time value", "krishisense-480507.firebasestorage.app"),
    messagingSenderId: ("TURBOPACK compile-time value", "789016695542"),
    appId: ("TURBOPACK compile-time value", "1:789016695542:web:86b303b3d464c04bd6e1cb")
};
// Check if Firebase config is properly set
const isConfigured = firebaseConfig.apiKey && firebaseConfig.apiKey !== 'your_api_key_here' && firebaseConfig.projectId;
...
if (isConfigured) {
    try {
        ...
        db = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getFirestore"])(app, "krishisense"); // Using named database 'krishisense'
    ...
    console.warn('⚠️ Firebase is not configured. Please set up your .env.local file with Firebase credentials.\n' + 'Copy .env.example to .env.local and fill in your Firebase config values.\n' + 'Get these from: Firebase Console > Project Settings > Your Apps > Web App');
}
const isFirebaseConfigured = isConfigured && app !== null;
;
...
function getAuth() {
    ...
    return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["auth"];
}
...
function AuthProvider({ children }) {
    ...
    const createUserProfile = async (uid, email, displayName, role)=>{
    ...
    const signIn = async (email, password)=>{
        try {
            setError(null);
            setLoading(true);
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$auth$2f$dist$2f$esm$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["signInWithEmailAndPassword"])(getAuth(), email, password);
        } catch (err) {
    ...
    const signUp = async (email, password, name, role)=>{
        try {
            setError(null);
            setLoading(true);
            const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$auth$2f$dist$2f$esm$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createUserWithEmailAndPassword"])(getAuth(), email, password);
            // Update display name
    ...
    // Sign in with Google
    const signInWithGoogle = async (role = 'farmer')=>{
        try {
            setError(null);
            setLoading(true);
            const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$auth$2f$dist$2f$esm$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["signInWithPopup"])(getAuth(), googleProvider);
            // Check if user profile exists
            const existingProfile = await fetchUserProfile(result.user.uid);
            if (!existingProfile) {
                // Create new profile for first-time Google users
                await createUserProfile(result.user.uid, result.user.email || '', result.user.displayName || '', role);
            }
            const profile = await fetchUserProfile(result.user.uid);
            setUserProfile(profile);
        } catch (err) {
    ...
    const signOut = async ()=>{
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$auth$2f$dist$2f$esm$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["signOut"])(getAuth());
            setUserProfile(null);
        } catch (err) {
    ...
    const resetPassword = async (email)=>{
        try {
            setError(null);
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$auth$2f$dist$2f$esm$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["sendPasswordResetEmail"])(getAuth(), email);
        } catch (err) {
    ...
    const value = {
        ...
        loading,
        error,
        isConfigured: !!__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isFirebaseConfigured"],
        signIn,
        signUp,
        signInWithGoogle,
        signOut,
...
_s(AuthProvider, "7HPOvfxHdRB8FUAjp2forANMju8=");
_c = AuthProvider;
function useAuth() {
    _s1();
...
//# sourceMappingURL=src_51ebab60._.js.map